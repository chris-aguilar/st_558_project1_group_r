...
For the State class plotting method we've developed a function that plots the mean value of enrollment across the years for each Division. The twenty "Error" values for Division have been removed in generating the subset prior to plotting the data.
